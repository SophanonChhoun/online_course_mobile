...
class _SettingsPageState extends State<SettingsPage> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            buildAccountChangeInfo(context, "Change Account Info"),
            SizedBox(
              height: 40,
            ),
            Row(
  ...
  GestureDetector buildAccountChangePw(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => EditPassoword()),
        );
      },
      child: Padding(
